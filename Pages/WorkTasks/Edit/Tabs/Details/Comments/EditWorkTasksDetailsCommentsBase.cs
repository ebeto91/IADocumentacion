...
namespace RAS823_MC_CiudadMunicipal_FrontEnd.Pages.WorkTasks.Edit.Tabs.Details.Comments
{
    public class EditWorkTasksDetailsCommentsBase : ComponentBase
    {
        [Parameter]
        public bool isViewParam { get; set; }

...
namespace RAS823_MC_CiudadMunicipal_FrontEnd.Pages.ControlInternalComplaint.ControlInternalComplaintList
{
    public class ControlInternalComplaintListBase : ComponentBase
    {
        [Parameter]
        ...
        protected async override Task OnInitializedAsync()
        {
            ...
            {
                Collections = ["PRIORITY", "STATUS-MANAGEMENT", "SUBPRINCIPALTYPE-APPLICATION-COMPLAINT"]
            };
        ...
        private async Task SearchData()
        {
            ...
            managementProfileInputFilterDto.PrincipalTypeApplication = "CORRUPTION";
        ...
        {
            _spinnerService.Show();
            _navigation.NavigateTo("/gestionCiudadana/solicitudes/crear");
            _spinnerService.Hide();
        }
        ...
        {
            _navigation.NavigateTo($"/gestionCiudadana/denuncias/editar/{managementProfileDto.Id}");
        }

        public void goToProcessDetail(ManagementProfileDto managementProfileDto)
        {
            _navigation.NavigateTo($"/gestionCiudadana/denuncias/detalle/{managementProfileDto.Id}");
        }

        public void goToProcessFollow(ManagementProfileDto managementProfileDto)
        {
            _navigation.NavigateTo($"/gestionCiudadana/denuncias/editar/seguimiento/{managementProfileDto.WorkTaskAssignedBefore}");
        }
        #endregion
    }
}

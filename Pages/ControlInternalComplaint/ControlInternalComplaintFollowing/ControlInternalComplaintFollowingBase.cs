...
using RAS823_MC_CiudadMunicipal_FrontEnd.Pages.ControlInternalComplaint.ControlInternalComplaintFollowing.Tabs.Details;
...
namespace RAS823_MC_CiudadMunicipal_FrontEnd.Pages.ControlInternalComplaint.ControlInternalComplaintFollowing
{
    public class ControlInternalComplaintFollowingBase : ComponentBase
    {
        ...
        [NotNull]
        public EditComplaintDetails editComplaintDetails { get; set; }
        ...
        #region historial
        [NotNull]
        public EditComplaintHistorial editComplaintHistorial { get; set; }
        #endregion
        ...
        public async Task OnClickTabItem(TabItem tabItem)
        {
            ...
            switch (childText)
            {
                ...
                case TABSDATA.HISTORY:
                    ...
                    await editComplaintHistorial.UpdateData(workTaskResponseDetailConsult, listCatalogData);
                    break;
        ...
        protected async override Task OnInitializedAsync()
        {
            ...
            if (response != null && response.response != null && response.response.Success)
            {
                ...
                {
                    Collections = ["PRIORITY", "STATUS-MANAGEMENT", "SUBPRINCIPALTYPE-APPLICATION-COMPLAINT", "POSITION-WORK-TASK", "TYPE-PROCCESS", "TYPE-WORKTASK",]
                };
                ...
                workTaskResponseDetail.TypeWorkTaskCustom = " custom ";
                workTaskResponseDetail.StartDateApplication = DateTime.MinValue;
                workTaskResponseDetail.DueRateApplication = DateTime.MinValue;
                ...
                await editComplaintDetails.UpdateData(listCatalogData,
                    workTaskResponseDetailConsult.ListAssignedUsers,
                    workTaskResponseDetailConsult.ListUsersSelectable,
                    workTaskId, workTaskResponseDetailConsult, listAutomaticResponse, listDistrictNeighborhoodsDefinition);
            }
            else
            {

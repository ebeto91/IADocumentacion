...
namespace RAS823_MC_CiudadMunicipal_FrontEnd.Pages.ControlInternalComplaint.ControlInternalComplaintFollowing.Tabs.Details
{
    public class EditComplaintDetailsBase : ComponentBase
    {
        ...
        [NotNull]
        public EditComplaintDetailsComments editComplaintDetailsComments { get; set; }
        ...
        protected async override Task OnInitializedAsync()
        {
            ...
            module = await _jsRuntime.InvokeAsync<IJSObjectReference>("import",
                             "./Pages/WorkTasks/Edit/Tabs/Details/EditWorkTasksDetails.razor.js");
        ...
        public async Task UpdateData(List<Catalog> catalogs, List<WorkTaskUsersAssignedDto> listUsers
            ...
            List<CatalogAutomaticResponseDto> catalogAutomaticResponseDtos, List<DistrictNeighborhoodsDefinition> districtNeighborhoodsDefinitions)
        {
            ...
            if (listCatalogData != null)
            {
                ...
                if (!string.IsNullOrEmpty(workTaskResponseDetailConsult.Latitude) && !string.IsNullOrEmpty(workTaskResponseDetailConsult.Longitude))
                {
                    latitude = workTaskResponseDetailConsult.Latitude;
                    longitude = workTaskResponseDetailConsult.Longitude;

                    await module.InvokeVoidAsync("Init", latitude, longitude);
                }

                if (editComplaintDetailsComments != null)
                {
                    await editComplaintDetailsComments.UpdateData(workTaskResponseDetail, UserProfile, workTaskId);
                }
                workTaskResponseDetail.TypeWorkTaskCustom = "";
                StateHasChanged();
            }
        ...
        public async Task saveGeneralData(EditContext formContext)
        {
            ...
            //}
            workTaskResponseDetail.StartDateApplication = null;
            workTaskResponseDetail.DueRateApplication = null;
            ...
            if (response != null && response.response != null && response.response.Success)
            {
                ...
                _navigationManager.NavigateTo("/gestionCiudadana/denuncias");
            }
            else
            {

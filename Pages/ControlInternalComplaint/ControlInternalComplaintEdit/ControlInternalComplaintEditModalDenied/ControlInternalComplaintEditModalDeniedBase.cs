...
namespace RAS823_MC_CiudadMunicipal_FrontEnd.Pages.ControlInternalComplaint.ControlInternalComplaintEdit.ControlInternalComplaintEditModalDenied
{
    public class ControlInternalComplaintEditModalDeniedBase : ComponentBase
    {
        [Inject]

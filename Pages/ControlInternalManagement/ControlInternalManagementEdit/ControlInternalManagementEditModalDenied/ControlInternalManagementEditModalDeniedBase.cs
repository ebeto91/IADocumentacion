...
namespace RAS823_MC_CiudadMunicipal_FrontEnd.Pages.ControlInternalManagement.ControlInternalManagementEdit.ControlInternalManagementEditModalDenied
{
    public class ControlInternalManagementEditModalDeniedBase : ComponentBase
    {
        [Inject]
        ...
        public List<SelectedItem> listDefaultResponseDenied { get; set; }
        [Parameter]
        ...
        public async Task HandleFormValid()
        {
            ...
            var response = await _managementService.DeniedManagement(handleManangement);

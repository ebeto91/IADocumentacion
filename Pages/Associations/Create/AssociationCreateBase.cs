...
namespace RAS823_MC_CiudadMunicipal_FrontEnd.Pages.Associations.Create
{
    public class AssociationCreateBase : ComponentBase
    {
        [Inject]
        ...
        public async Task HandleFormValid()
        {
            ...
            var response = await _associationService.PostAssociation(handleAssociationConfig);

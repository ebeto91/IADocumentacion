...
namespace RAS823_MC_CiudadMunicipal_FrontEnd.Pages.ControlInternalSurvey.ControlInternalSurveyList
{
    public class ControlInternalSurveyListBase : ComponentBase
    {
        [Parameter]
        ...
        public async Task viewResultsInternal()
        {

           
            _navigation.NavigateTo("/resultados");
           
        }

        #region go to
        public void goToProcessReview(SurveyResponse surveyResponse)
        {
            _spinnerService.Show();
        ...
        public void goToProcessEditProcess(SurveyResponse surveyResponse)
        {
            _spinnerService.Show();
            _navigation.NavigateTo($"/encuestas/editar/{surveyResponse.Id}");
            _spinnerService.Hide();
        }

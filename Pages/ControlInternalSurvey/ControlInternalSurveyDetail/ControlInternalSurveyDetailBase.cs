...
namespace RAS823_MC_CiudadMunicipal_FrontEnd.Pages.ControlInternalSurvey.ControlInternalSurveyDetail
{

    public class ControlInternalSurveyDetailBase : ComponentBase
    {
        ...
        private string validScopes { get; } = "Detail:Survey";

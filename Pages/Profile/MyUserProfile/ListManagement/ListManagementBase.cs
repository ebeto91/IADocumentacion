...
namespace RAS823_MC_CiudadMunicipal_FrontEnd.Pages.Profile.MyUserProfile.ListManagement
{
    public class ListManagementBase : ComponentBase
    {
        [Parameter]
        ...
        {
            _navigation.NavigateTo($"/miperfil/detalle/{managementProfileDto.Id}");
        }

...
namespace RAS823_MC_CiudadMunicipal_FrontEnd.Pages.Profile.MyUserProfile.ListComplaints.ViewDetailComplaint
{
    public class ViewDetailComplaintBase : ComponentBase
    {
        [Parameter]
